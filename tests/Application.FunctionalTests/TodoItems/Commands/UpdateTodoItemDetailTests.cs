using Zeira.Application.TodoItems.Commands.CreateTodoItem;
using Zeira.Application.TodoItems.Commands.UpdateTodoItem;
using Zeira.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Zeira.Application.TodoLists.Commands.CreateTodoList;
using Zeira.Domain.Entities;
using Zeira.Domain.Enums;

namespace Zeira.Application.FunctionalTests.TodoItems.Commands;
